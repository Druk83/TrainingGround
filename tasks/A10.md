...
## Чек-лист готовности
- [ ] Коллекция `feature_flags` создана с индексами и валидацией.
- [ ] Rust/Python/PWA проверяют флаги через единый интерфейс с кэшированием.
- [ ] Admin API позволяет управлять флагами с аудитом и валидацией зависимостей.
- [ ] Frontend корректно скрывает/показывает функциональность в зависимости от флагов.
- [ ] Метрики и алерты для изменений флагов интегрированы в мониторинг.
- [ ] Документация описывает все флаги, их назначение и влияние на систему.
