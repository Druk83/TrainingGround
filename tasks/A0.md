...
- [ ] **ВРУЧНУЮ:** Выполнить `git config core.hooksPath .githooks`
- [ ] **ВРУЧНУЮ:** Выполнить `powershell -ExecutionPolicy Bypass -File scripts\setup-dev.ps1`
- [ ] **ВРУЧНУЮ:** Удалить файл `tasks\A0-COMPLETED.md` (если существует)
